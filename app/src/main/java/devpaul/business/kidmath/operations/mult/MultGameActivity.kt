package devpaul.business.kidmath.operations.mult
...
class MultGameActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_mult_game)
    ...
    private fun fistlevelGame() {
        ...
        countDownTimer = object : CountDownTimer(millisUntilFinished!!, 1000) {
            ...
            override fun onFinish() {
                ...
                val intent = Intent(this@MultGameActivity, GameOverMultiplicacionActivity::class.java)
